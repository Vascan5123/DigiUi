// TODO - add controls for DigiUI compoenents 
...
//     this.settings = JSON.parse(app.data.settings["vascan.settingsFromAdmin"]);
...
//                 m('label', app.translator.trans('vascan-digi-ui.admin.settings.title')),
//                 !this.settingStates.hideMainPageMenu ? // check if 'mainPageMenu' is not selected
//                   m('.Form-group', [ // allDiscussionsIcon
//                     m('label', app.translator.trans('vascan-digi-ui.admin.settings.icon')),
//                     m('.helpText', app.translator.trans('vascan-digi-ui.admin.settings.icon_help_text', { text: allDiscussions })),
//                     m('.inline',
...
//                             }
//                           },
//                           m('li', app.translator.trans(`vascan-digi-ui.admin.settings.${key}`))
//                           ),
//                           m('.helpText', app.translator.trans(`vascan-digi-ui.admin.settings.${key}_help_text`)),
//                         ]) : ''
//                     ];
//                   }
...
//                 m('label', app.translator.trans('vascan-digi-ui.admin.routes.title')),
...
//                   return m('.Form-group', [
//                     m('label', app.translator.trans('vascan-digi-ui.admin.routes.route_label', { route: key })),
//                     m('.helpText', app.translator.trans(`vascan-digi-ui.admin.routes.${key}`)),
...
//                           m('span.Default-Routes-Placeholder-Hint', app.translator.trans('vascan-digi-ui.admin.routes.hint')),
//                           ' ',
...
//           type: "error"
//         },
//         app.translator.trans('vascan-digi-ui.admin.routes.same_value')
//       );
...
//     try {
//       saveSettings({
//         ["vascan.settingsFromAdmin"]: JSON.stringify(this.settings)});
//       app.alerts.show(
//         Alert,
//         {
//           type: "success"
